---
name: running-blender
description: "Implements Blender CLI tasks using a bundled feature catalog and offline Python API evidence. Use when creating, editing, exporting, or validating Blender assets for JFTSE Content Studio."
---
