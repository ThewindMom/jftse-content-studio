...
export function isOriginalModel(file: string): boolean {
  return /^Studio\/Oktoberfest\/Oktoberfest_(BrewersPavilion|PretzelStand|GingerbreadStand|FoodStand|BeerGarden|FestivalArch|Festzelt|Maypole|WelcomeMaypole|BarrelDisplay|PretzelDisplay|BarrelWagon|Bandstand|HouseBanner|FlagLine|FlagPost|FountainGarland|FountainCrown|CourtCrest|CornerInlay|CourtRibbon|CourtCorner|JudgeDressing|NetDressing|Brewmaster|Accordionist|PretzelBaker|FestivalChick)\.glb$/.test(file);
}
